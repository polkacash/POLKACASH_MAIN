...
contract Cash is ERC20Burnable, Operator {
     ...
     */
    constructor() public ERC20('POC', 'POC') {
        // Mints 1 polka Cash to contract creator for initial Uniswap oracle deployment.
    ...
    //        require(
    //            to != operator(),
    //            "polka.cash: operator as a recipient is not allowed"
    //        );
    //    }
