...
contract USDCPOSLPTokenSharePool is
    LPTokenWrapper,
    IRewardDistributionRecipient
{
    ...
    modifier checkStart() {
        require(
            ...
            'USDCPOSLPTokenSharePool: not start'
        );
        _;
    }
    ...
    function stake(uint256 amount)
        ...
        checkStart
    {
        require(amount > 0, 'USDCPOSLPTokenSharePool: Cannot stake 0');
        super.stake(amount);
    ...
    function withdraw(uint256 amount)
        ...
        checkStart
    {
        require(amount > 0, 'USDCPOSLPTokenSharePool: Cannot withdraw 0');
